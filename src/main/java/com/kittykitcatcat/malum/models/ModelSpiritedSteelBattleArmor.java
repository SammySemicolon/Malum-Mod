...
public class ModelSpiritedSteelBattleArmor extends ModelArmor
{
    ...
    public ModelSpiritedSteelBattleArmor(EquipmentSlotType slot)
    {
        ...
        torso.setTextureOffset(36, 52).addBox(-4.5F, 5.5F, -2.5F, 9.0F, 6.0F, 5.0F, -0.1F, false);
        ...
        chestplate_slope.setRotationPoint(-8.0F, -18.0F, 5.0F);
        torso.addChild(chestplate_slope);
        setRotationAngle(chestplate_slope, 0.2618F, 0.0F, 0.0F);
        chestplate_slope.setTextureOffset(19, 22).addBox(6.0F, 21.1116F, -13.9391F, 4.0F, 2.0F, 1.0F, 0.0F, false);
