...
public class MalumLang extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder builder) {
        ...
        builder.add(DataHelper.take(blocks, BlockRegistry.PRIMORDIAL_SOUP).get(), "The Weeping Well");
        builder.add(DataHelper.take(blocks, BlockRegistry.VOID_CONDUIT).get(), "The Weeping Well");
        ...
        blocks.forEach(b ->
        {
            ...
            builder.add(b.get().getDescriptionId(), name);
        });
        ...
        items.forEach(i ->
        {
            ...
            name = makeProper(DataHelper.toTitleCase(correctItemName(name), "_"));
            builder.add(i.get().getDescriptionId(), name);
        });
        builder.add("item.malum.music_disc_aesthetica.desc", "Kultik - Aesthetica");
        ...
        enchantments.forEach(e -> {
            ...
            builder.add(e.get().getDescriptionId(), name);
        });
        ...
        effects.forEach(e -> {
            ...
            builder.add("effect.malum." + BuiltInRegistries.MOB_EFFECT.getKey(e.get()).getPath(), name);
        });

        attributes.forEach(a -> {
            String name = DataHelper.toTitleCase(a.getId().getPath(), "_");
            builder.add("attribute.name.malum." + BuiltInRegistries.ATTRIBUTE.getKey(a.get()).getPath(), name);
        });

        entities.forEach(e -> {
            String name = DataHelper.toTitleCase(e.getId().getPath(), "_");
            builder.add("entity.malum." + BuiltInRegistries.ENTITY_TYPE.getKey(e.get()).getPath(), name);
        });

        spirits.forEach(s -> builder.add(s.getSpiritDescription(), DataHelper.toTitleCase(s.identifier + "_spirit", "_")));
        ...
        for (CrucibleTuning.CrucibleAttributeType value : CrucibleTuning.CrucibleAttributeType.values()) {
            ...
            builder.add(translation, name);
        }
        builder.add("malum.gui.crucible.attribute.weakest_boost", "Weakest Boost");
        builder.add("malum.gui.crucible.attribute.tuning_potency", "Tuning Potency");

        builder.add("malum.gui.augment.slot", "Slot: ");
        builder.add("malum.gui.augment.installed", "When installed: ");
        builder.add("malum.gui.augment.type.augment", "Augment");
        builder.add("malum.gui.augment.type.core_augment", "Core Augment");


        builder.add("malum.gui.rite.type", "Type: ");
        builder.add("malum.gui.rite.medium", "Polarity: ");
        builder.add("malum.gui.rite.coverage", "Coverage: ");
        builder.add("malum.gui.rite.effect", "Effect: ");
        ...
        addRiteEffectCategory(builder, TotemicRiteEffect.MalumRiteEffectCategory.DIRECTIONAL_BLOCK_EFFECT);
        addRiteEffectCategory(builder, TotemicRiteEffect.MalumRiteEffectCategory.RADIAL_BLOCK_EFFECT);
        addRiteEffectCategory(builder, TotemicRiteEffect.MalumRiteEffectCategory.ONE_TIME_EFFECT);

        addRite(builder, SpiritRiteRegistry.SACRED_RITE, "Rite of Healing", "Rite of Nourishment");
        addRite(builder, SpiritRiteRegistry.WICKED_RITE, "Rite of Decay", "Rite of Empowerment");
        addRite(builder, SpiritRiteRegistry.EARTHEN_RITE, "Rite of Warding", "Rite of the Arena");
        addRite(builder, SpiritRiteRegistry.INFERNAL_RITE, "Rite of Haste", "Rite of the Hells");
        addRite(builder, SpiritRiteRegistry.AERIAL_RITE, "Rite of Motion", "Rite of the Aether");
        addRite(builder, SpiritRiteRegistry.AQUEOUS_RITE, "Rite of Loyalty", "Rite of the Seas");

        addRite(builder, SpiritRiteRegistry.ARCANE_RITE, "Undirected Rite", "Unchained Rite");

        addRite(builder, SpiritRiteRegistry.ELDRITCH_SACRED_RITE, "Rite of Growth", "Rite of Lust");
        addRite(builder, SpiritRiteRegistry.ELDRITCH_WICKED_RITE, "Rite of Exorcism", "Rite of Culling");
        addRite(builder, SpiritRiteRegistry.ELDRITCH_EARTHEN_RITE, "Rite of Destruction", "Rite of Shaping");
        addRite(builder, SpiritRiteRegistry.ELDRITCH_INFERNAL_RITE, "Rite of Smelting", "Rite of Quickening");
        addRite(builder, SpiritRiteRegistry.ELDRITCH_AERIAL_RITE, "Rite of Gravity", "Rite of Unwinding");
        addRite(builder, SpiritRiteRegistry.ELDRITCH_AQUEOUS_RITE, "Rite of Sapping", "Rite of Drowning");

        builder.add("malum.gui.ritual.type", "Ritual Type: ");
        builder.add("malum.gui.ritual.tier", "Ritual Tier: ");
        ...
        for (MalumRitualType ritualType : RitualRegistry.RITUALS) {
            ...
            builder.add("malum.gui.ritual." + id, name);
        }
        ...
        builder.add("trinkets.slot.head.necklace", "Necklace");
        builder.add("trinkets.slot.legs.rune", "Rune");
        ...
        addSimpleEntryHeader(builder, "chronicles_of_the_void", "Chronicles of the Void", "A magecraft of madness");
        addSimpleEntryHeader(builder, "chronicles_of_the_soul", "Chronicles of the Soul", "A magecraft of miracles");

        addSimpleEntryHeader(builder, "void.the_weeping_well", "The Weeping Well", "Gate to the unknown");
        addPages(builder, "void.the_weeping_well",
        ...
        addEntryHeader(builder, "void.material_study_soulstone", "Material Study: Soulstone", "An old friend");
        addHeadline(builder, "void.material_study_soulstone", "Study: Soulstone");
        addPages(builder, "void.material_study_soulstone",
        ...
        addEntryHeader(builder, "void.material_study_mnemonic_fragment", "Material Study: Condensed Brilliance", "Not experience, but memory");
        addHeadline(builder, "void.material_study_mnemonic_fragment", "Study: Mnemosyne");
        addPages(builder, "void.material_study_mnemonic_fragment",
        ...
        addSimpleEntryHeader(builder, "void.material_study_mnemonic_fragment.reexamination", "Reexamination: Mnemnosyne", "Patterns holding true");
        addPages(builder, "void.material_study_mnemonic_fragment.reexamination",
        ...
        addEntryHeader(builder, "void.material_study_null_slate", "Material Study: Refined Soulstone", "A blank slate, perhaps a precursor");
        addHeadline(builder, "void.material_study_null_slate", "Study: Null Slate");
        addPages(builder, "void.material_study_null_slate",
        ...
        addSimpleEntryHeader(builder, "void.material_study_null_slate.reexamination", "Reexamination: Null Slate", "Attuned to Umbral");
        addPages(builder, "void.material_study_null_slate.reexamination",
        ...
        addEntryHeader(builder, "void.material_study_void_salts", "Material Study: Purified Ash", "A clue to the nature of souls");
        addHeadline(builder, "void.material_study_void_salts", "Study: Void Salts");
        addPages(builder, "void.material_study_void_salts",
        ...
        addSimpleEntryHeader(builder, "void.material_study_void_salts.reexamination", "Reexamination: Void Salts", "Concerning");
        addPages(builder, "void.material_study_void_salts.reexamination",
        ...
        addEntryHeader(builder, "void.material_study_auric_embers", "Material Study: Blazing Exaltation", "The essence of progress");
        addHeadline(builder, "void.material_study_auric_embers", "Study: Auric Ember");
        addPages(builder, "void.material_study_auric_embers",
        ...
        addSimpleEntryHeader(builder, "void.material_study_auric_embers.reexamination", "Reexamination: Auric Ember", "Not stripping away, but inverting");
        addPages(builder, "void.material_study_auric_embers.reexamination",
        ...
        addEntryHeader(builder, "void.material_study_malignant_lead", "Material Study: Putrefacted Gold", "Perfection cast to base");
        addHeadline(builder, "void.material_study_malignant_lead", "Study: Malignant Lead");
        addPages(builder, "void.material_study_malignant_lead",
        ...
        addEntryHeader(builder, "void.material_study_malignant_lead.reexamination", "Reexamination: Malignant Lead", "Wicked and Umbral");
        addHeadline(builder, "void.material_study_malignant_lead.reexamination", "Reexamining Malignant Lead");
        addPages(builder, "void.material_study_malignant_lead.reexamination",
        ...
        addSimpleEntryHeader(builder, "spirit_metals.reexamination", "Reexamination: Spirit Metals", "A different principle");
        addPages(builder, "spirit_metals.reexamination",
        ...
        addSimpleEntryHeader(builder, "spirit_stones.reexamination", "Reexamination: Spirit Stones", "Tessellation of crystal structures");
        addPages(builder, "spirit_stones.reexamination",
        ...
        addSimpleEntryHeader(builder, "cthonic_gold.reexamination", "Reexamination: Cthonic Gold", "A new principle in old material");
        addPages(builder, "cthonic_gold.reexamination",
        ...
        addEntryHeader(builder, "spirit_minerals.reexamination", "Reexamination: Soulstone and Brilliance", "More than just arcana");
        addHeadline(builder, "spirit_minerals.reexamination", "Reexamining Spirit Minerals");
        addPages(builder, "spirit_minerals.reexamination",
        ...
        addSimpleEntryHeader(builder, "void.umbral_arcana", "Umbral Arcana", "Utter impossibility");
        addPages(builder, "void.umbral_arcana",
        ...
        addEntryHeader(builder, "void.inverse_and_hybrid_arcana", "Inverse and Hybrid Arcana?", "Failed theories");
        addHeadline(builder, "void.inverse_and_hybrid_arcana", "Theoretical Arcana");
        addPages(builder, "void.inverse_and_hybrid_arcana",
        ...
        addEntryHeader(builder, "void.material_study_arcana", "Material Study: the Arcana", "New depths to old wells");
        addHeadline(builder, "void.material_study_arcana", "Study: Spirit Crystal");
        addPages(builder, "void.material_study_arcana",
        ...
        addSimpleEntryHeader(builder, "void.staves_as_foci", "Staves as Foci", "Imitating the arcana");
        addPages(builder, "void.staves_as_foci",
        ...
        addSimpleEntryHeader(builder, "void.staves_as_foci.ring_of_the_endless_well", "Ring of the Endless Well", "Storing staff charges");
        addPages(builder, "void.staves_as_foci.ring_of_the_endless_well",
        ...
        addSimpleEntryHeader(builder, "void.malignant_pewter", "Malignant Pewter", "Progress cast false");
        addPages(builder, "void.malignant_pewter",
        ...
        addEntryHeader(builder, "void.malignant_stronghold_armor", "Malignant Stronghold Armor", "The defense of the inevitable");
        ...
        addSimpleEntryHeader(builder, "void.erosion_scepter", "Erosion Scepter", "May mages fear my might");
        addPages(builder, "void.erosion_scepter",
        ...
        addSimpleEntryHeader(builder, "void.ring_of_growing_flesh", "Ring of Growing Flesh", "Creeping and crawling");
        addPages(builder, "void.ring_of_growing_flesh",
        ...
        addEntryHeader(builder, "void.ring_of_gruesome_concentration", "Ring of Gruesome Concentration", "Consume and incorporate");
        addHeadline(builder, "void.ring_of_gruesome_concentration", "Gruesome Concentration");
        addPages(builder, "void.ring_of_gruesome_concentration",
        ...
        addSimpleEntryHeader(builder, "void.necklace_of_the_watcher", "Necklace of the Watcher", "It looks back");
        addPages(builder, "void.necklace_of_the_watcher",
        ...
        addEntryHeader(builder, "void.necklace_of_the_hidden_blade", "Necklace of the Hidden Blade", "A knife at their backs");
        addHeadline(builder, "void.necklace_of_the_hidden_blade", "The Hidden Blade");
        addPages(builder, "void.necklace_of_the_hidden_blade",
        ...
        addHeadline(builder, "runewood.runic_sap", "Runic Sap");
        addPages(builder, "runewood.runic_sap",
        ...
        addHeadline(builder, "esoteric_reaping.warp_flux", "Warp Flux");
        addPages(builder, "esoteric_reaping.warp_flux",
        ...
        addHeadline(builder, "spirit_infusion.living_flesh", "Living Flesh");
        addPages(builder, "spirit_infusion.living_flesh",
        ...
        addHeadline(builder, "spirit_infusion.alchemical_calx", "Alchemical Calx");
        addPages(builder, "spirit_infusion.alchemical_calx",
        ...
        addSimpleEntryHeader(builder, "elemental_arcana", "Elemental Arcana", "Focused magic");
        ...
        addSimpleEntryHeader(builder, "mending_diffuser", "Mending Diffuser", "Unliving scar tissue");
        addPages(builder, "mending_diffuser",
        ...
        addSimpleEntryHeader(builder, "impurity_stabilizer", "Impurity Stabilizer", "Potency from weakness");
        addPages(builder, "impurity_stabilizer",
        ...
        addSimpleEntryHeader(builder, "shielding_apparatus", "Shielding Apparatus", "A bulwark against the storm");
        addPages(builder, "shielding_apparatus",
        ...
        addSimpleEntryHeader(builder, "warping_engine", "Warping Engine", "Suspension of linear time");
        addPages(builder, "warping_engine",
        ...
        addSimpleEntryHeader(builder, "prismatic_focus_lens", "Prismatic Focus Lens", "Stability");
        addPages(builder, "prismatic_focus_lens",
        ...
        addSimpleEntryHeader(builder, "accelerating_inlay", "Accelerating Inlay", "Doubling down");
        addPages(builder, "accelerating_inlay",
        ...
        addSimpleEntryHeader(builder, "blazing_diode", "Blazing Diode", "The strongest force in the world");
        addPages(builder, "blazing_diode",
        ...
        addSimpleEntryHeader(builder, "intricate_assembly", "Intricate Assembly", "Fudging the numbers");
        addPages(builder, "intricate_assembly",
        ...
        addPages("belt_of_the_starved.concentrated_gluttony",
                "My newfound reliance on rotten meals has led me to develop a denser form of consumable rot. Concentrated Gluttony, I flinch at the idea of even calling it food. When consumed it'll grant me the gluttony effect - the drink reacts to rot; amplifying the effect with each rotten trinket worn.");
        ...
        addSimpleEntryHeader(builder, "belt_of_the_prospector.ring_of_the_hoarder", "Ring of the Hoarder", "Directly into my veins");
        ...
        addSimpleEntryHeader(builder, "belt_of_the_prospector.ring_of_the_demolitionist", "Ring of the Demolitionist", bold("More dakka"));
        addPages(builder, "belt_of_the_prospector.ring_of_the_demolitionist",
        ...
        addEntryHeader(builder, "necklace_of_blissful_harmony", "Necklace of Blissful Harmony", "No sign of morning coming");
        addHeadline(builder, "necklace_of_blissful_harmony", "The Blissful Harmony");
        ...
        addEntryHeader(builder, "runeworking", "Runeworking", "The central pin");
        addHeadline(builder, "runeworking", "Runeworking");
        addPages(builder, "runeworking",
        ...
        addEntryHeader(builder, "runic_brooch", "Runic Brooch", "Power in the palms");
        addHeadline(builder, "runic_brooch", "Runic Brooch");
        addPages(builder, "runic_brooch",
        ...
        addEntryHeader(builder, "glass_brooch", "Glass Brooch", "Fragile power");
        addHeadline(builder, "glass_brooch", "Glass Brooch");
        addPages(builder, "glass_brooch",
        ...
        addEntryHeader(builder, "elaborate_brooch", "Elaborate Brooch", "A change in purpose");
        addHeadline(builder, "elaborate_brooch", "Elaborate Brooch");
        addPages(builder, "elaborate_brooch",
        ...
        addEntryHeader(builder, "gluttonous_brooch", "Gluttonous Brooch", "Endlessly unsated");
        addHeadline(builder, "gluttonous_brooch", "Gluttonous Brooch");
        addPages(builder, "gluttonous_brooch",
        ...
        addSimpleEntryHeader(builder, "rune_of_idle_restoration", "Rune of Idle Restoration", "The impulse to mend");
        addPages(builder, "rune_of_idle_restoration",
        ...
        addSimpleEntryHeader(builder, "rune_of_culling", "Rune of Culling", "The impulse to break");
        addPages(builder, "rune_of_culling",
        ...
        addSimpleEntryHeader(builder, "rune_of_aliment_cleansing", "Rune of Aliment Cleansing", "The impulse to process");
        addPages(builder, "rune_of_aliment_cleansing",
        ...
        addSimpleEntryHeader(builder, "rune_of_fervor", "Rune of Fervor", "The impulse to expend");
        addPages(builder, "rune_of_fervor",
                "The Rune of Fervor implores a mind to move with haste, improving the user's mining speed by roughly a quarter.");
        addSimpleEntryHeader(builder, "rune_of_reactive_shielding", "Rune of Reactive Shielding", "The impulse to withstand");
        addPages(builder, "rune_of_reactive_shielding",
        ...
        addSimpleEntryHeader(builder, "rune_of_dexterity", "Rune of Dexterity", "The impulse to flee");
        addPages(builder, "rune_of_dexterity",
        ...
        addSimpleEntryHeader(builder, "rune_of_reinforcement", "Rune of Reinforcement", "The impulse to make");
        addPages(builder, "rune_of_reinforcement",
        ...
        addSimpleEntryHeader(builder, "rune_of_volatile_distortion", "Rune of Volatile Distortion", "The impulse to putrefy");
        addPages(builder, "rune_of_volatile_distortion",
        ...
        addSimpleEntryHeader(builder, "void.runes", "Voidish Runecraft", "An altered alphabet");
        addPages(builder, "void.runes",
        ...
        addSimpleEntryHeader(builder, "void.rune_of_bolstering", "Rune of Bolstering", "To heal what is whole");
        addPages(builder, "void.rune_of_bolstering",
        ...
        addEntryHeader(builder, "void.rune_of_sacrificial_empowerment", "Rune of Sacrificial Empowerment", "To break what is broken");
        addHeadline(builder, "void.rune_of_sacrificial_empowerment", "Sacrificial Empowerment");
        addPages(builder, "void.rune_of_sacrificial_empowerment",
        ...
        addSimpleEntryHeader(builder, "void.rune_of_twinned_duration", "Rune of Twinned Duration", "To suspend what must process");
        addPages(builder, "void.rune_of_twinned_duration",
        ...
        addSimpleEntryHeader(builder, "void.rune_of_igneous_solace", "Rune of Igneous Solace", "To fuel what must burn");
        addPages(builder, "void.rune_of_igneous_solace",
        ...
        addSimpleEntryHeader(builder, "void.rune_of_toughness", "Rune of Toughness", "To bear what must break");
        addPages(builder, "void.rune_of_toughness",
                "The Rune of Toughness reinforces the user's armor, making any armor they already wear more effective and tough.");
        addSimpleEntryHeader(builder, "void.rune_of_unnatural_stamina", "Rune of Unnatural Stamina", "To flee what must pursue");
        addPages(builder, "void.rune_of_unnatural_stamina",
        ...
        addSimpleEntryHeader(builder, "void.rune_of_spell_mastery", "Rune of Spell Mastery", "To make what destroys");
        addPages(builder, "void.rune_of_spell_mastery",
        ...
        addSimpleEntryHeader(builder, "void.rune_of_the_heretic", "Rune of the Heretic", "To destroy what makes");
        addPages(builder, "void.rune_of_the_heretic",
        ...
        addSimpleEntryHeader(builder, "totemic_runes", "Totemic Runes", "Ritual as runecraft");
        addPages(builder, "totemic_runes",
        ...
        addSimpleEntryHeader(builder, "rune_of_motion", "Rune of Motion", "Uplifting your impulses");
        addPages(builder, "rune_of_motion",
        ...
        addSimpleEntryHeader(builder, "rune_of_loyalty", "Rune of Loyalty", "Molding your impulses");
        addPages(builder, "rune_of_loyalty",
        ...
        addSimpleEntryHeader(builder, "rune_of_warding", "Rune of Warding", "Grounding your impulses");
        addPages(builder, "rune_of_warding",
        ...
        addSimpleEntryHeader(builder, "rune_of_haste", "Rune of Haste", "Igniting your impulses");
        addPages(builder, "rune_of_haste",
        ...
        addSimpleEntryHeader(builder, "rune_of_the_aether", "Rune of the Aether", "Scattering your impulses");
        addPages(builder, "rune_of_the_aether",
        ...
        addSimpleEntryHeader(builder, "rune_of_the_seas", "Rune of the Seas", "Deforming your impulses");
        addPages(builder, "rune_of_the_seas",
        ...
        addSimpleEntryHeader(builder, "rune_of_the_arena", "Rune of the Arena", "Honing your impulses");
        addPages(builder, "rune_of_the_arena",
        ...
        addSimpleEntryHeader(builder, "rune_of_the_hells", "Rune of the Hells", "Extinguishing your impulses");
        addPages(builder, "rune_of_the_hells",
        ...
        addSimpleEntryHeader(builder, "ritual_magic", "Ritual magic", "Grand Magics");
        addPages(builder, "ritual_magic", "The future holds many secrets..");
        ...
        addHeadline(builder, "arcane_rite.soulwood", "Soulwood Transmutation");

        addRiteEntry(builder, "arcane_rite",
        ...
        addRiteEntry(builder, "corrupt_arcane_rite",
        ...
        addRiteEntry(builder, "sacred_rite",
        ...
        addRiteEntry(builder, "greater_sacred_rite",
        ...
        addRiteEntry(builder, "corrupt_sacred_rite",
        ...
        addRiteEntry(builder, "corrupt_greater_sacred_rite",
        ...
        addRiteEntry(builder, "wicked_rite",
        ...
        addRiteEntry(builder, "greater_wicked_rite",
        ...
        addRiteEntry(builder, "corrupt_wicked_rite",
        ...
        addRiteEntry(builder, "corrupt_greater_wicked_rite",
        ...
        addRiteEntry(builder, "aerial_rite", "A simple aura rite, while active nearby friendly beings will find their movements sped up.",
                "Applies Zephyr's Courage, increasing movement speed by two fifths.");
        addRiteEntry(builder, "greater_aerial_rite",
        ...
        addRiteEntry(builder, "corrupt_aerial_rite",
        ...
        addRiteEntry(builder, "corrupt_greater_aerial_rite",
        ...
        addRiteEntry(builder, "earthen_rite",
        ...
        addRiteEntry(builder, "greater_earthen_rite",
        ...
        addRiteEntry(builder, "corrupt_earthen_rite",
        ...
        addRiteEntry(builder, "corrupt_greater_earthen_rite",
        ...
        addRiteEntry(builder, "infernal_rite",
        ...
        addRiteEntry(builder, "greater_infernal_rite",
        ...
        addRiteEntry(builder, "corrupt_infernal_rite",
        ...
        addRiteEntry(builder, "corrupt_greater_infernal_rite",
        ...
        addRiteEntry(builder, "aqueous_rite",
        ...
        addRiteEntry(builder, "greater_aqueous_rite",
        ...
        addRiteEntry(builder, "corrupt_aqueous_rite",
        ...
        addRiteEntry(builder, "corrupt_greater_aqueous_rite",
        ...
        addSimpleEntryHeader(builder, "belt_of_the_magebane", "Belt of the Magebane", "Newfound ruin");
        addPages(builder, "belt_of_the_magebane", "The Belt of the Magebane is a simple innovation, but a dangerously effective one. Normally, after being struck by any attack, soul ward will not recover until a long moment after. That moment of downtime has proven itself detrimental far too frequently. But that ends now.",
        ...
        builder.add("malum.spirit.flavour.umbral", "Antithesis");
        ...
        builder.add("itemGroup.malum_metallurgic_magics", "Malum: Metallurgic Magics");
        builder.add("itemGroup.malum_void_chronicles", "Malum: Chronicles of the Void");
        builder.add("itemGroup.malum_ritual_shards", "Malum: Ritual Shards");
        builder.add("itemGroup.malum_cosmetics", "Malum: Self Expression");
        ...
        builder.add("death.attack." + DamageTypeRegistry.VOODOO_IDENTIFIER, "%s had their soul shattered");
        builder.add("death.attack." + DamageTypeRegistry.VOODOO_IDENTIFIER + ".player", "%s had their soul shattered by %s");
    ...
    public void addTetraMaterial(TranslationBuilder builder, String identifier, String name) {
        builder.add("tetra.material." + identifier, name);
        builder.add("tetra.material." + identifier + ".prefix", name);
    }

    public void addRite(TranslationBuilder builder, TotemicRiteType riteType, String basicName, String corruptName) {
        builder.add(riteType.translationIdentifier(false), basicName);
        builder.add(riteType.translationIdentifier(true), corruptName);
    }

    public void addRiteEffectCategory(TranslationBuilder builder, TotemicRiteEffect.MalumRiteEffectCategory category) {
        builder.add(category.getTranslationKey(), DataHelper.toTitleCase(category.name().toLowerCase(), "_"));
    }

    public void addTetraImprovement(TranslationBuilder builder, String identifier, String name, String description) {
        builder.add("tetra.improvement." + identifier + ".name", name);
        builder.add("tetra.improvement." + identifier + ".description", description);
    }

    public void addRiteEntry(TranslationBuilder builder, String identifier, String riteDescription, String riteHoverDescription) {
        builder.add("malum.gui.book.entry.page.text." + identifier, riteDescription);
        builder.add("malum.gui.book.entry.page.text." + identifier + ".hover", riteHoverDescription);
    }
    ...
    public void addEffectDescription(TranslationBuilder builder, Supplier<MobEffect> mobEffectSupplier, String description) {
        builder.add(mobEffectSupplier.get().getDescriptionId() + ".description", description);
    }
