...
import com.sammy.malum.data.builder.vanilla.TheDeviceRecipeBuilder;
...
import static com.sammy.malum.data.builder.vanilla.MetalNodeCookingRecipeBuilder.blastingWithTag;
import static com.sammy.malum.data.builder.vanilla.MetalNodeCookingRecipeBuilder.smeltingWithTag;
import static com.sammy.malum.data.builder.vanilla.StackedMalumCookingRecipeBuilder.blastingWithCount;
import static com.sammy.malum.data.builder.vanilla.StackedMalumCookingRecipeBuilder.smeltingWithCount;
...
public class MalumRecipes extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        smelting(Ingredient.of(ItemRegistry.BLOCK_OF_AURUM.get()), ItemRegistry.AURIC_REMNANT.get(), 2.0f, 200).unlockedBy("has_rare_earths", has(ItemRegistry.AURIC_REMNANT.get())).save(consumer, malumPath("rare_earths_from_smelting"));
        blasting(Ingredient.of(ItemRegistry.BLOCK_OF_AURUM.get()), ItemRegistry.AURIC_REMNANT.get(), 2.0f, 100).unlockedBy("has_rare_earths", has(ItemRegistry.AURIC_REMNANT.get())).save(consumer, malumPath("rare_earths_from_blasting"));
