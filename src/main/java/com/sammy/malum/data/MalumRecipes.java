...
public class MalumRecipes extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        shaped(ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS_WALL.get(), 6).define('#', ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS.get()).pattern("###").pattern("###").unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer);
        smelting(Ingredient.of(ItemRegistry.TAINTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS.get(), 0.1f, 200).unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS_SLAB.get(), 6).define('#', ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS.get()).pattern("###").unlockedBy("has_cracked_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS_STAIRS.get(), 4).define('#', ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS.get()).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_cracked_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer);
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS_SLAB.get(), 2).unlockedBy("has_cracked_tainted_rock_bricks", has(ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS.get())).save(consumer, malumPath("cracked_tainted_rock_bricks_slab_stonecutting"));
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS_STAIRS.get()).unlockedBy("has_cracked_tainted_rock_bricks", has(ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS.get())).save(consumer, malumPath("cracked_tainted_rock_bricks_stairs_stonecutting"));
        ...
        smelting(Ingredient.of(ItemRegistry.TAINTED_ROCK_TILES.get()), ItemRegistry.RUNIC_TAINTED_ROCK_TILES.get(), 0.1f, 200).unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_TAINTED_ROCK_TILES_SLAB.get(), 6).define('#', ItemRegistry.RUNIC_TAINTED_ROCK_TILES.get()).pattern("###").unlockedBy("has_cracked_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_TAINTED_ROCK_TILES_STAIRS.get(), 4).define('#', ItemRegistry.RUNIC_TAINTED_ROCK_TILES.get()).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_cracked_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_TAINTED_ROCK_TILES_WALL.get(), 6).define('#', ItemRegistry.RUNIC_TAINTED_ROCK_TILES.get()).pattern("###").pattern("###").unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer);
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_TAINTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_TAINTED_ROCK_TILES.get()).unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer, malumPath("cracked_tainted_rock_tiles_stonecutting"));
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_TAINTED_ROCK_TILES.get()), ItemRegistry.RUNIC_TAINTED_ROCK_TILES_SLAB.get(), 2).unlockedBy("has_cracked_tainted_rock_tiles", has(ItemRegistry.RUNIC_TAINTED_ROCK_TILES.get())).save(consumer, malumPath("cracked_tainted_rock_tiles_slab_stonecutting"));
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_TAINTED_ROCK_TILES.get()), ItemRegistry.RUNIC_TAINTED_ROCK_TILES_STAIRS.get()).unlockedBy("has_cracked_tainted_rock_tiles", has(ItemRegistry.RUNIC_TAINTED_ROCK_TILES.get())).save(consumer, malumPath("cracked_tainted_rock_tiles_stairs_stonecutting"));
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_TAINTED_ROCK_TILES.get()), ItemRegistry.RUNIC_TAINTED_ROCK_TILES_WALL.get()).unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer, malumPath("cracked_tainted_rock_tiles_wall_stonecutting"));
        ...
        smelting(Ingredient.of(ItemRegistry.SMALL_TAINTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS.get(), 0.1f, 200).unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer, malumPath("cracked_small_tainted_rock_bricks_smelting"));
        shaped(ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS_SLAB.get(), 6).define('#', ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS.get()).pattern("###").unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS_STAIRS.get(), 4).define('#', ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS.get()).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS_WALL.get(), 6).define('#', ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS.get()).pattern("###").pattern("###").unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer);
        stonecutting(Ingredient.of(ItemRegistry.TAINTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS.get()).unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer, malumPath("cracked_small_tainted_rock_bricks_stonecutting_alt"));

        stonecutting(Ingredient.of(ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS_SLAB.get(), 2).unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer, malumPath("cracked_small_tainted_rock_bricks_slab_stonecutting"));
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS_STAIRS.get()).unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer, malumPath("cracked_small_tainted_rock_bricks_stairs_stonecutting"));
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_SMALL_TAINTED_ROCK_BRICKS_WALL.get()).unlockedBy("has_tainted_rock", has(ItemRegistry.TAINTED_ROCK.get())).save(consumer, malumPath("cracked_small_tainted_rock_bricks_wall_stonecutting"));
        ...
        shaped(ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS_WALL.get(), 6).define('#', ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS.get()).pattern("###").pattern("###").unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer);
        smelting(Ingredient.of(ItemRegistry.TWISTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS.get(), 0.1f, 200).unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS_SLAB.get(), 6).define('#', ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS.get()).pattern("###").unlockedBy("has_cracked_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS_STAIRS.get(), 4).define('#', ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS.get()).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_cracked_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer);
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS_SLAB.get(), 2).unlockedBy("has_cracked_twisted_rock_bricks", has(ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS.get())).save(consumer, malumPath("cracked_twisted_rock_bricks_slab_stonecutting"));
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS_STAIRS.get()).unlockedBy("has_cracked_twisted_rock_bricks", has(ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS.get())).save(consumer, malumPath("cracked_twisted_rock_bricks_stairs_stonecutting"));
        ...
        smelting(Ingredient.of(ItemRegistry.TWISTED_ROCK_TILES.get()), ItemRegistry.RUNIC_TWISTED_ROCK_TILES.get(), 0.1f, 200).unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_TWISTED_ROCK_TILES_SLAB.get(), 6).define('#', ItemRegistry.RUNIC_TWISTED_ROCK_TILES.get()).pattern("###").unlockedBy("has_cracked_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_TWISTED_ROCK_TILES_STAIRS.get(), 4).define('#', ItemRegistry.RUNIC_TWISTED_ROCK_TILES.get()).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_cracked_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_TWISTED_ROCK_TILES_WALL.get(), 6).define('#', ItemRegistry.RUNIC_TWISTED_ROCK_TILES.get()).pattern("###").pattern("###").unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer);
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_TWISTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_TWISTED_ROCK_TILES.get()).unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer, malumPath("cracked_twisted_rock_tiles_stonecutting"));
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_TWISTED_ROCK_TILES.get()), ItemRegistry.RUNIC_TWISTED_ROCK_TILES_SLAB.get(), 2).unlockedBy("has_cracked_twisted_rock_tiles", has(ItemRegistry.RUNIC_TWISTED_ROCK_TILES.get())).save(consumer, malumPath("cracked_twisted_rock_tiles_slab_stonecutting"));
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_TWISTED_ROCK_TILES.get()), ItemRegistry.RUNIC_TWISTED_ROCK_TILES_STAIRS.get()).unlockedBy("has_cracked_twisted_rock_tiles", has(ItemRegistry.RUNIC_TWISTED_ROCK_TILES.get())).save(consumer, malumPath("cracked_twisted_rock_tiles_stairs_stonecutting"));
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_TWISTED_ROCK_TILES.get()), ItemRegistry.RUNIC_TWISTED_ROCK_TILES_WALL.get()).unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer, malumPath("cracked_twisted_rock_tiles_wall_stonecutting"));
        ...
        smelting(Ingredient.of(ItemRegistry.SMALL_TWISTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS.get(), 0.1f, 200).unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer, malumPath("cracked_small_twisted_rock_bricks_smelting"));
        shaped(ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS_SLAB.get(), 6).define('#', ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS.get()).pattern("###").unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS_STAIRS.get(), 4).define('#', ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS.get()).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer);
        shaped(ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS_WALL.get(), 6).define('#', ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS.get()).pattern("###").pattern("###").unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer);
        stonecutting(Ingredient.of(ItemRegistry.TWISTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS.get()).unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer, malumPath("cracked_small_twisted_rock_bricks_stonecutting_alt"));

        stonecutting(Ingredient.of(ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS_SLAB.get(), 2).unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer, malumPath("cracked_small_twisted_rock_bricks_slab_stonecutting"));
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS_STAIRS.get()).unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer, malumPath("cracked_small_twisted_rock_bricks_stairs_stonecutting"));
        stonecutting(Ingredient.of(ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS.get()), ItemRegistry.RUNIC_SMALL_TWISTED_ROCK_BRICKS_WALL.get()).unlockedBy("has_twisted_rock", has(ItemRegistry.TWISTED_ROCK.get())).save(consumer, malumPath("cracked_small_twisted_rock_bricks_wall_stonecutting"));
