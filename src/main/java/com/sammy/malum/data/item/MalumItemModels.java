...
public class MalumItemModels extends LodestoneItemModelProvider {
    ...
    protected void registerModels() {
        ...
        MalumItemModelSmithTypes.GENERATED_OVERLAY_ITEM.act(data, items.stream().filter(i -> i.get() instanceof MalumRuneCurioItem).collect(Collectors.toList()));
        ...
        ItemModelSmithTypes.HANDHELD_ITEM.act(data, SOUL_STAINED_STEEL_KNIFE, TUNING_FORK, TOTEMIC_STAFF);
