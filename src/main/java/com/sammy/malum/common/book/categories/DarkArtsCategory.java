...
public class DarkArtsCategory extends BookCategory
{
    ...
    public DarkArtsCategory()
    {
        ...
        addEntries(voodooMagic, poppetBelt, offensivePoppets, defensivePoppets, poppetOfUndying, totemMagic, poppetBlessings, riteOfLife, riteOfDeath, riteOfMagic, riteOfEarth, riteOfFire, riteOfAir, riteOfWater, riteOfGrowth, riteOfDrought, riteOfRain);
    }
}
