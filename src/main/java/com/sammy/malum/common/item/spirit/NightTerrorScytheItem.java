...
public class NightTerrorScytheItem extends MagicScytheItem {
    public NightTerrorScytheItem(Tier tier, float attackDamageIn, float attackSpeedIn, float magicDamage, Properties builderIn) {
