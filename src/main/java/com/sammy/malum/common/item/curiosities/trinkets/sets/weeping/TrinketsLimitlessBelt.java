...
public class TrinketsLimitlessBelt extends MalumTinketsItem implements IMalumEventResponderItem, IVoidItem {

    public TrinketsLimitlessBelt(Properties builder) {
