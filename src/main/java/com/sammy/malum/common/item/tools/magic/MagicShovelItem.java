...
import com.sammy.malum.common.item.tools.ModShovelItem;
...
public class MagicShovelItem extends ModShovelItem {

    public final float magicDamage;
    public MagicShovelItem(Tier material, int damage, float speed, float magicDamage, Properties properties) {
