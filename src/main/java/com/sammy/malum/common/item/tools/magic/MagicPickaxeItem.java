...
import com.sammy.malum.common.item.tools.ModPickaxeItem;
...
public class MagicPickaxeItem extends ModPickaxeItem {

    public final float magicDamage;
    public MagicPickaxeItem(Tier material, int damage, float speed, float magicDamage, Properties properties) {
