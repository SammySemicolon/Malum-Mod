...
public class CurioHeavenlyPendant extends Item implements ICurio
{
    public CurioHeavenlyPendant(Properties builder)
    {
        super(builder);
    }
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundNBT unused)
    {
        return CurioProvider.createProvider(new ICurio()
        {
            ...
            public Multimap<Attribute, AttributeModifier> getAttributeModifiers(String identifier)
            {
                ...
                map.put(Attributes.MOVEMENT_SPEED, new AttributeModifier(SPEED, MalumMod.MODID + ":speed_boost", 0.1f, AttributeModifier.Operation.MULTIPLY_TOTAL));
                return map;
            }
