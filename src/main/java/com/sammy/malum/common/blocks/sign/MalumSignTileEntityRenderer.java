...
public class MalumSignTileEntityRenderer extends SignTileEntityRenderer
{
    private final SignTileEntityRenderer.SignModel model = new SignTileEntityRenderer.SignModel();
    
    public MalumSignTileEntityRenderer(TileEntityRendererDispatcher rendererDispatcherIn)
    {
    ...
    public static RenderMaterial getRenderType()
    {
        return new RenderMaterial(SIGN_ATLAS, MalumHelper.prefix("entity/signs/" + woodType.getName()));
    }
}