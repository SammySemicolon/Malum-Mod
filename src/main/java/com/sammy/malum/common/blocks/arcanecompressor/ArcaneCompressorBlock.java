...
public class ArcaneCompressorBlock extends Block implements IWaterLoggable
{
    public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

    public ArcaneCompressorBlock(Properties properties)
    {
        super(properties);
    ...
    public final VoxelShape shape = Stream.of(
            ...
            Block.makeCuboidShape(-3, 10, -3, 2, 19, 2),
            Block.makeCuboidShape(14, 10, 14, 19, 19, 19),
            Block.makeCuboidShape(14, 10, -3, 19, 19, 2),
            Block.makeCuboidShape(-3, 10, 14, 2, 19, 19)
    ...
    {
        return new ArcaneCompressorTileEntity();
    }
