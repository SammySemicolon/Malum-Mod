...
public class TotemPoleRenderer extends TileEntityRenderer<TotemPoleTileEntity>
{
    ...
    public void render(TotemPoleTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn)
    {
        ...
        renderTheThing(tileEntityIn,matrixStackIn,bufferIn);
    }
    ...
    public void renderTheThing(TotemPoleTileEntity totemPoleTileEntity, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn)
    {
        ...
        matrixStackIn.rotate(Vector3f.YP.rotationDegrees(-totemPoleTileEntity.getBlockState().get(BlockStateProperties.HORIZONTAL_FACING).getHorizontalAngle() - 90));
        matrixStackIn.translate(-0.5, 0, -0.5);
