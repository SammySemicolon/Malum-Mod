...
public class TaintedTallGrassBlock extends MalumTallGrassBlock implements ITaintSpreader
{
    public TaintedTallGrassBlock(Properties properties, RegistryObject<Block> blockRegistryObject)
    {
        super(properties, blockRegistryObject);
    }
    @Override
