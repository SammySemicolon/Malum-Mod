...
public class REIHandler implements REIClientPlugin {
    ...
    public static final CategoryIdentifier<RuneworkingRecipeCategory.RuneworkingDisplay> RUNEWORKING = CategoryIdentifier
            .of(MalumMod.malumPath("runeworking"));

    @Override
    public void registerCategories(CategoryRegistry registry) {
        registry.add(new RuneworkingRecipeCategory());
    }
