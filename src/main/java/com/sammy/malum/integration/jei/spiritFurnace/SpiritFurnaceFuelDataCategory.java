...
public class SpiritFurnaceFuelDataCategory implements IRecipeCategory<SpiritFurnaceFuelData>
{
    ...
    public SpiritFurnaceFuelDataCategory(IGuiHelper guiHelper)
    {
        ...
        overlay = guiHelper.createDrawable(new ResourceLocation(MalumMod.MODID, "textures/gui/spirit_furnace_fuel_overlay.png"), 0, -1, 59, 20);
    ...
    public void draw(SpiritFurnaceFuelData data, MatrixStack matrixStack, double mouseX, double mouseY)
    {
        ...
        ITextComponent timeComponent = ClientHandler.makeTranslationComponent("malum.fuel.time").append(new StringTextComponent("" + data.getFuelTime()));
