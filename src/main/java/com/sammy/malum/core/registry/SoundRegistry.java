...
public class SoundRegistry
{
    ...
    public static final SoundType TAINTED_ROCK = new SoundType(1.0F, 1.1F, TAINTED_ROCK_BREAK, TAINTED_ROCK_STEP, TAINTED_ROCK_PLACE, TAINTED_ROCK_HIT, SoundEvents.BASALT_FALL);
    public static final SoundType TWISTED_ROCK = new SoundType(1.0F, 0.85F, TAINTED_ROCK_BREAK, TAINTED_ROCK_STEP, TAINTED_ROCK_PLACE, TAINTED_ROCK_HIT, SoundEvents.BASALT_FALL);
