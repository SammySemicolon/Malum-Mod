...
public class EntityRegistry
{
    ...
    public static final RegistryObject<EntityType<MalumBoatEntity>> RUNEWOOD_BOAT = ENTITY_TYPES.register("runewood_boat",
            () -> EntityType.Builder.<MalumBoatEntity>create((t, w)->new MalumBoatEntity(t, w, ItemRegistry.RUNEWOOD_BOAT, ItemRegistry.RUNEWOOD_PLANKS), EntityClassification.MISC).size(1.375F, 0.5625F).trackingRange(10)
    ...
    public static final RegistryObject<EntityType<MalumBoatEntity>> SOULWOOD_BOAT = ENTITY_TYPES.register("soulwood_boat",
            () -> EntityType.Builder.<MalumBoatEntity>create((t, w)->new MalumBoatEntity(t, w, ItemRegistry.SOULWOOD_BOAT, ItemRegistry.SOULWOOD_PLANKS), EntityClassification.MISC).size(1.375F, 0.5625F).trackingRange(10)
