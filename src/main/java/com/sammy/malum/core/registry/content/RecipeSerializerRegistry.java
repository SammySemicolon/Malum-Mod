...
public class RecipeSerializerRegistry {
    ...
    public static final RegistryObject<RecipeSerializer<SpiritCrucibleRecipe>> CRUCIBLE_RECIPE_SERIALIZER = RECIPE_SERIALIZERS.register(SpiritCrucibleRecipe.NAME, SpiritCrucibleRecipe.Serializer::new);
