...
public class FeatureRegistry
{
    ...
    public static void register()
    {
        ...
        BLAZE_QUARTZ_ORE = Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, MalumMod.MODID + ":" + "blaze_quartz_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, BlockRegistry.BLAZING_QUARTZ_ORE.get().getDefaultState(), CommonConfig.BLAZE_QUARTZ_SIZE.get())).range(128).square().func_242731_b(20));
        BRILLIANT_STONE = Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, MalumMod.MODID + ":" + "brilliant_stone", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, BlockRegistry.BRILLIANT_STONE.get().getDefaultState(), CommonConfig.BRILLIANT_STONE_SIZE.get())).withPlacement(Placement.DEPTH_AVERAGE.configure(new DepthAverageConfig(16, 8))).square());

        SOULSTONE_ORE = Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, MalumMod.MODID + ":" + "soulstone_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, BlockRegistry.SOULSTONE_ORE.get().getDefaultState(), CommonConfig.SURFACE_SOULSTONE_SIZE.get())).withPlacement(Placement.DEPTH_AVERAGE.configure(new DepthAverageConfig(16, 16))).square());
        SOULSTONE_ORE_SURFACE = Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, MalumMod.MODID + ":" + "soulstone_ore_surface", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, BlockRegistry.SOULSTONE_ORE.get().getDefaultState(), CommonConfig.SOULSTONE_SIZE.get())).withPlacement(Placement.DEPTH_AVERAGE.configure(new DepthAverageConfig(64, 16))).square());
    }
