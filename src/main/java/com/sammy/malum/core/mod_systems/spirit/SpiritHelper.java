...
import com.sammy.malum.core.mod_systems.container.ItemInventory;
...
public class SpiritHelper {
    ...
    public static void pickupSpirit(ItemStack item, LivingEntity collector) {
        SpiritHelper.collectSpirit(collector);
        ...
        MalumHelper.giveItemToEntity(item, collector);
    }
