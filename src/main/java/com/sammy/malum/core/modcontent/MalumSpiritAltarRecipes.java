...
public class MalumSpiritAltarRecipes
{
    ...
    public static void init()
    {
        ...
        new MalumSpiritAltarRecipe(new MalumItemIngredient(Tags.Items.COBBLESTONE, 16), new MalumItemIngredient(MalumItems.TWISTED_ROCK.get(), 16),new MalumSpiritIngredient(MalumSpiritTypes.DEATH_SPIRIT),new MalumSpiritIngredient(MalumSpiritTypes.MAGIC_SPIRIT));
        ...
        new MalumSpiritAltarRecipe(new MalumItemIngredient(MalumItems.SOUL_STAINED_STEEL_INGOT.get(), 4), new MalumItemIngredient(MalumItems.ABYSSAL_APPARATUS.get(), 2),new MalumSpiritIngredient(MalumSpiritTypes.DEATH_SPIRIT, 4),new MalumSpiritIngredient(MalumSpiritTypes.MAGIC_SPIRIT, 4), new MalumSpiritIngredient(MalumSpiritTypes.ELDRITCH_SPIRIT, 1));
        ...
        new MalumSpiritAltarRecipe(new MalumItemIngredient(MalumItems.TAINTED_ROCK.get(), 8), new MalumItemIngredient(MalumItems.IMPERVIOUS_ROCK.get(), 8),new MalumSpiritIngredient(MalumSpiritTypes.DEATH_SPIRIT));
    
        new MalumSpiritAltarRecipe(new MalumItemIngredient(MalumItems.SOUL_STAINED_STEEL_HELMET.get(), 1), new MalumItemIngredient(MalumItems.SOUL_STAINED_STRONGHOLD_HELMET.get(), 1),new MalumSpiritIngredient(MalumSpiritTypes.LIFE_SPIRIT, 4),new MalumSpiritIngredient(MalumSpiritTypes.DEATH_SPIRIT, 4), new MalumSpiritIngredient(MalumSpiritTypes.EARTH_SPIRIT, 8), new MalumSpiritIngredient(MalumSpiritTypes.ELDRITCH_SPIRIT, 2));
        new MalumSpiritAltarRecipe(new MalumItemIngredient(MalumItems.SOUL_STAINED_STEEL_CHESTPLATE.get(), 1), new MalumItemIngredient(MalumItems.SOUL_STAINED_STRONGHOLD_CHESTPLATE.get(), 1),new MalumSpiritIngredient(MalumSpiritTypes.LIFE_SPIRIT, 4),new MalumSpiritIngredient(MalumSpiritTypes.DEATH_SPIRIT, 4), new MalumSpiritIngredient(MalumSpiritTypes.FIRE_SPIRIT, 8), new MalumSpiritIngredient(MalumSpiritTypes.ELDRITCH_SPIRIT, 2));
        new MalumSpiritAltarRecipe(new MalumItemIngredient(MalumItems.SOUL_STAINED_STEEL_LEGGINGS.get(), 1), new MalumItemIngredient(MalumItems.SOUL_STAINED_STRONGHOLD_LEGGINGS.get(), 1),new MalumSpiritIngredient(MalumSpiritTypes.LIFE_SPIRIT, 4),new MalumSpiritIngredient(MalumSpiritTypes.DEATH_SPIRIT, 4), new MalumSpiritIngredient(MalumSpiritTypes.AIR_SPIRIT, 8), new MalumSpiritIngredient(MalumSpiritTypes.ELDRITCH_SPIRIT, 2));
        new MalumSpiritAltarRecipe(new MalumItemIngredient(MalumItems.SOUL_STAINED_STEEL_BOOTS.get(), 1), new MalumItemIngredient(MalumItems.SOUL_STAINED_STRONGHOLD_BOOTS.get(), 1),new MalumSpiritIngredient(MalumSpiritTypes.LIFE_SPIRIT, 4),new MalumSpiritIngredient(MalumSpiritTypes.DEATH_SPIRIT, 4), new MalumSpiritIngredient(MalumSpiritTypes.WATER_SPIRIT, 8), new MalumSpiritIngredient(MalumSpiritTypes.ELDRITCH_SPIRIT, 2));
        ...
        new MalumSpiritAltarRecipe(new MalumItemIngredient(MalumItems.POPPET.get(), 1), new MalumItemIngredient(MalumItems.POPPET_OF_FIRE.get(), 1),new MalumSpiritIngredient(MalumSpiritTypes.LIFE_SPIRIT, 6), new MalumSpiritIngredient(MalumSpiritTypes.FIRE_SPIRIT, 6));
        new MalumSpiritAltarRecipe(new MalumItemIngredient(MalumItems.POPPET.get(), 1), new MalumItemIngredient(MalumItems.POPPET_OF_EARTH.get(), 1),new MalumSpiritIngredient(MalumSpiritTypes.DEATH_SPIRIT, 4), new MalumSpiritIngredient(MalumSpiritTypes.EARTH_SPIRIT, 8));
