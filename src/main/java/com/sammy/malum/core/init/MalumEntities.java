...
public class MalumEntities
{
    ...
    public static final RegistryObject<EntityType<SoulItemEntity>> SPIRIT_ESSENCE = ENTITY_TYPES.register("spirit_essence",
            () -> EntityType.Builder.create(SoulItemEntity::new, EntityClassification.MISC).size(0.5F, 0.75F)
