...
public class MalumEnchantmentTypes
{
    ...
    public static final EnchantmentType SCYTHE_DAGGER_ONLY = EnchantmentType.create(MalumMod.MODID + ":scythe_dagger_only", i -> i instanceof ScytheItem || i instanceof PithingNeedleItem);
