...
public class MalumTileEntities
{
    ...
    public static final RegistryObject<TileEntityType<?>> TOTEM_CORE_TILE_ENTITY = TILE_ENTITIES.register("totem_core_tile_entity", () -> TileEntityType.Builder.create((Supplier<TileEntity>) ItemStandTileEntity::new, MalumBlocks.TOTEM_CORE.get()).build(null));
}
