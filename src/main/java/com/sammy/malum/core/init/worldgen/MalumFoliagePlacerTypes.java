...
public class MalumFoliagePlacerTypes
{
    ...
    public static RegistryObject<FoliagePlacerType<GradientFoliagePlacer>> SUN_KISSED_TREE = FOLIAGE.register("sun_kissed_foliage_placer", () -> new FoliagePlacerType<>(GradientFoliagePlacer.type));
}