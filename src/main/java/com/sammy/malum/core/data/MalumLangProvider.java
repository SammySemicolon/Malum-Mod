...
public class MalumLangProvider extends LanguageProvider
{
    ...
    protected void addTranslations()
    {
        ...
        addPage("spirit_infusion_a", "Spirit infusion is a crafting process that revolves around infusing spirit magic into various items, twisting them to fit your evil desires. Every infusion recipe requires a prime item to be placed right on the altar, as well as spirits to infuse the item with.");
        ...
        addPage("hex_ash_a", "Hex ash is a simple magical powder used in creating various magical items. The ash can animate things, bring them to life in some extreme cases even. It's crated by infusing gunpowder with arcane spirit.");
        ...
        addPage("runewood_trees_2", "Runewood trees are an odd mixture of arcane spirit combined with what used to be a large oak tree. Due to this, runewood is a perfect conductor for magic and is the basis of many arcane devices and various ritualistic appliances. Processing it in a furnace also yields a special type of charcoal.");
