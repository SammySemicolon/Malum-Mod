...
public class MalumRecipes extends RecipeProvider
{
    ...
    {
        ShapelessRecipeBuilder.shapelessRecipe(MalumItems.ENCYCLOPEDIA_ARCANA.get()).addIngredient(Items.BOOK).addIngredient(MalumItems.PROCESSED_SOULSTONE.get()).addCriterion("has_soulstone", hasItem(MalumItems.PROCESSED_SOULSTONE.get())).build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(MalumItems.SPIRIT_ALTAR.get()).key('Z', Tags.Items.INGOTS_GOLD).key('Y', MalumItems.PROCESSED_SOULSTONE.get()).key('X', MalumItems.RUNEWOOD_PLANKS.get()).patternLine(" Y ").patternLine("ZXZ").patternLine("XXX").addCriterion("has_soulstone", hasItem(MalumItems.SOULSTONE_CLUSTER.get())).build(consumer);
        ...
        smeltingRecipe(Ingredient.fromItems(MalumItems.BRILLIANT_STONE.get()), MalumItems.BRILLIANCE_CHUNK.get(),0.25f,200).addCriterion("has_brilliance", hasItem(MalumItems.BRILLIANCE_CLUSTER.get())).build(consumer);
        blastingRecipe(Ingredient.fromItems(MalumItems.BRILLIANT_STONE.get()), MalumItems.BRILLIANCE_CHUNK.get(),0.25f,100).addCriterion("has_brilliance", hasItem(MalumItems.BRILLIANCE_CLUSTER.get())).build(consumer, "brilliance_from_blasting");
        ShapedRecipeBuilder.shapedRecipe(MalumItems.BLOCK_OF_BRILLIANCE.get()).key('#', MalumItems.BRILLIANCE_CHUNK.get()).patternLine("###").patternLine("###").patternLine("###").addCriterion("has_brilliance", hasItem(MalumItems.BRILLIANCE_CLUSTER.get())).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(MalumItems.BRILLIANCE_CHUNK.get(), 9).addIngredient(MalumItems.BLOCK_OF_BRILLIANCE.get()).addCriterion("has_brilliance", hasItem(MalumItems.BRILLIANCE_CLUSTER.get())).build(consumer, "brilliance_from_block");

        smeltingRecipe(Ingredient.fromItems(MalumItems.SOULSTONE_ORE.get()), MalumItems.PROCESSED_SOULSTONE.get(),0.25f,200).addCriterion("has_soulstone", hasItem(MalumItems.SOULSTONE_CLUSTER.get())).build(consumer);
        blastingRecipe(Ingredient.fromItems(MalumItems.SOULSTONE_ORE.get()), MalumItems.PROCESSED_SOULSTONE.get(),0.25f,100).addCriterion("has_soulstone", hasItem(MalumItems.SOULSTONE_CLUSTER.get())).build(consumer, "soulstone_from_blasting");
        ShapedRecipeBuilder.shapedRecipe(MalumItems.BLOCK_OF_SOULSTONE.get()).key('#', MalumItems.PROCESSED_SOULSTONE.get()).patternLine("###").patternLine("###").patternLine("###").addCriterion("has_soulstone", hasItem(MalumItems.SOULSTONE_CLUSTER.get())).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(MalumItems.PROCESSED_SOULSTONE.get(), 9).addIngredient(MalumItems.BLOCK_OF_SOULSTONE.get()).addCriterion("has_soulstone", hasItem(MalumItems.SOULSTONE_CLUSTER.get())).build(consumer, "soulstone_from_block");

        smeltingRecipe(Ingredient.fromItems(MalumItems.BLAZING_QUARTZ_ORE.get()), MalumItems.BLAZING_QUARTZ.get(),0.25f,200).addCriterion("has_blaze_quartz", hasItem(MalumItems.BLAZING_QUARTZ.get())).build(consumer);
        blastingRecipe(Ingredient.fromItems(MalumItems.BLAZING_QUARTZ_ORE.get()), MalumItems.BLAZING_QUARTZ.get(),0.25f,100).addCriterion("has_blaze_quartz", hasItem(MalumItems.BLAZING_QUARTZ.get())).build(consumer, "blazing_quartz_from_blasting");
        ShapedRecipeBuilder.shapedRecipe(MalumItems.BLOCK_OF_BLAZING_QUARTZ.get()).key('#', MalumItems.BLAZING_QUARTZ.get()).patternLine("###").patternLine("###").patternLine("###").addCriterion("has_blaze_quartz", hasItem(MalumItems.BLAZING_QUARTZ.get())).build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(Items.LEAD, 2).key('~', Tags.Items.STRING).key('O', MalumItemTags.SAPBALLS).patternLine("~~ ").patternLine("~O ").patternLine("  ~").addCriterion("has_sapball", hasItem(MalumItemTags.SAPBALLS)).build(consumer);

        shapedRecipe(MalumItems.GILDED_BELT.get()).key('#', MalumItems.HALLOWED_GOLD_INGOT.get()).key('X', Tags.Items.LEATHER).key('Y', MalumItems.PROCESSED_SOULSTONE.get()).patternLine("XXX").patternLine("#Y#").patternLine(" # ").addCriterion("has_hallowed_gold", hasItem(MalumItems.HALLOWED_GOLD_INGOT.get())).build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(MalumItems.CRUDE_SCYTHE.get()).key('#', Items.STICK).key('Y', MalumItems.PROCESSED_SOULSTONE.get()).key('X', Tags.Items.INGOTS_IRON).patternLine("XXY").patternLine(" #X").patternLine("#  ").addCriterion("has_soulstone", hasItem(MalumItems.SOULSTONE_CLUSTER.get())).build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(MalumItems.BLOCK_OF_SOUL_STAINED_STEEL.get()).key('#', MalumItems.SOUL_STAINED_STEEL_INGOT.get()).patternLine("###").patternLine("###").patternLine("###").addCriterion("has_soul_stained_steel", hasItem(MalumItems.SOUL_STAINED_STEEL_INGOT.get())).build(consumer);
        ...
        ShapelessRecipeBuilder.shapelessRecipe(MalumItems.SOUL_STAINED_STEEL_INGOT.get(), 9).addIngredient(MalumItems.BLOCK_OF_SOUL_STAINED_STEEL.get()).addCriterion("has_soul_stained_steel", hasItem(MalumItems.SOUL_STAINED_STEEL_INGOT.get())).build(consumer, "soul_stained_steel_from_soul_stained_steel_block");

        ShapedRecipeBuilder.shapedRecipe(MalumItems.BLOCK_OF_HALLOWED_GOLD.get()).key('#', MalumItems.HALLOWED_GOLD_INGOT.get()).patternLine("###").patternLine("###").patternLine("###").addCriterion("has_hallowed_gold", hasItem(MalumItems.HALLOWED_GOLD_INGOT.get())).build(consumer);
        ...
        ShapelessRecipeBuilder.shapelessRecipe(MalumItems.HALLOWED_GOLD_INGOT.get(),9).addIngredient(MalumItems.BLOCK_OF_HALLOWED_GOLD.get()).addCriterion("has_hallowed_gold", hasItem(MalumItems.HALLOWED_GOLD_INGOT.get())).build(consumer, "hallowed_gold_ingot_from_hallowed_gold_block");
        ...
        ShapelessRecipeBuilder.shapelessRecipe(Items.EXPERIENCE_BOTTLE).addIngredient(MalumItems.BRILLIANCE_CHUNK.get()).addIngredient(Items.GLASS_BOTTLE).addCriterion("has_confined_brilliance", hasItem(MalumItems.BRILLIANCE_CHUNK.get())).build(consumer);
