...
public class MalumRecipeProvider extends RecipeProvider
{
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer)
    {
        ...
        ShapelessRecipeBuilder.shapelessRecipe(MalumItems.ENCYCLOPEDIA_ARCANA.get()).addIngredient(MalumItems.LAVENDER.get()).addIngredient(Items.BOOK).addCriterion("has_unholy_blend", hasItem(MalumItems.UNHOLY_BLEND.get())).build(consumer);
