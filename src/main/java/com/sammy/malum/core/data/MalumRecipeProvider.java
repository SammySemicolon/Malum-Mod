...
public class MalumRecipeProvider extends RecipeProvider
{
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer)
    {
        ...
        ShapelessRecipeBuilder.shapelessRecipe(MalumItems.ENCYCLOPEDIA_ARCANA.get()).addIngredient(MalumItems.GRIMSLATE_PLATING.get()).addIngredient(Items.BOOK).addCriterion("has_grimslate", hasItem(MalumItems.GRIMSLATE_ORE.get())).build(consumer);

        smeltingRecipe(Ingredient.fromItems(MalumItems.GRIMSLATE_ORE.get()), MalumItems.GRIMSLATE_PLATING.get(),0.25f,200).addCriterion("has_grimslate", hasItem(MalumItems.GRIMSLATE_ORE.get())).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(MalumItems.GRIMSLATE_BLOCK.get()).key('#', MalumItems.GRIMSLATE_PLATING.get()).patternLine("###").patternLine("###").patternLine("###").addCriterion("has_grimslate", hasItem(MalumItems.GRIMSLATE_ORE.get())).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(MalumItems.GRIMSLATE_PLATING.get(), 9).addIngredient(MalumItems.GRIMSLATE_BLOCK.get()).addCriterion("has_grimslate", hasItem(MalumItems.GRIMSLATE_ORE.get())).build(consumer, "grimslate_plating_alt");
        ...
        shapedRecipe(MalumItems.GILDED_BELT.get()).key('#', MalumItems.HALLOWED_GOLD_INGOT.get()).key('X', Items.LEATHER).key('Y', MalumItems.GRIMSLATE_PLATING.get()).patternLine("XXX").patternLine("#Y#").patternLine(" # ").addCriterion("has_hallowed_gold", hasItem(MalumItems.HALLOWED_GOLD_INGOT.get())).build(consumer);
        ...
        shapedRecipe(MalumItems.UNRELENTING_BELT.get()).key('#', MalumItems.IMPERVIOUS_ROCK.get()).key('Z', MalumItems.GILDED_BELT.get()).key('Y', Items.LEATHER).key('X', MalumItems.GRIMSLATE_PLATING.get()).patternLine(" # ").patternLine("YZY").patternLine("X#X").addCriterion("has_impervious_rock", hasItem(MalumItems.IMPERVIOUS_ROCK.get())).build(consumer);
        
        ShapedRecipeBuilder.shapedRecipe(MalumItems.CRUDE_SCYTHE.get()).key('#', Items.STICK).key('Y', MalumItems.GRIMSLATE_PLATING.get()).key('X', Items.IRON_INGOT).patternLine("XXY").patternLine(" #X").patternLine("#  ").addCriterion("has_grimslate", hasItem(MalumItems.GRIMSLATE_ORE.get())).build(consumer);
        ...
        shapedRecipe(MalumItems.TWISTED_ROCK.get(), 9).key('#', MalumItems.TAINTED_ROCK.get()).key('X', Items.BLACKSTONE).patternLine("###").patternLine("#X#").patternLine("###").addCriterion("has_tainted_rock", hasItem(MalumItems.TAINTED_ROCK.get())).build(consumer);
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MalumItems.TWISTED_ROCK_BRICKS.get()), MalumItems.TWISTED_ROCK_BRICKS_SLAB.get(), 2).addCriterion("has_twisted_rock_bricks", hasItem(MalumItems.TWISTED_ROCK_BRICKS.get())).build(consumer, "twisted_rock_bricks_slab_stonecutting");
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MalumItems.TWISTED_ROCK_BRICKS.get()), MalumItems.TWISTED_ROCK_BRICKS_STAIRS.get()).addCriterion("has_twisted_rock_bricks", hasItem(MalumItems.TWISTED_ROCK_BRICKS.get())).build(consumer, "twisted_rock_bricks_stairs_stonecutting");
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MalumItems.TWISTED_ROCK_BRICKS.get()), MalumItems.TWISTED_ROCK_BRICKS_WALL.get()).addCriterion("has_twisted_rock_bricks", hasItem(MalumItems.TWISTED_ROCK_BRICKS.get())).build(consumer, "twisted_rock_brick_wall_stonecutting");
        ...
        shapelessRecipe(MalumItems.MOSSY_TWISTED_ROCK_BRICKS.get()).addIngredient(MalumItems.TWISTED_ROCK_BRICKS.get()).addIngredient(Blocks.VINE).addCriterion("has_twisted_rock", hasItem(MalumItems.TWISTED_ROCK.get())).build(consumer);
        shapedRecipe(MalumItems.MOSSY_TWISTED_ROCK_BRICKS_SLAB.get(), 6).key('#', MalumItems.MOSSY_TWISTED_ROCK_BRICKS.get()).patternLine("###").addCriterion("has_twisted_rock", hasItem(MalumItems.TWISTED_ROCK.get())).build(consumer);
        shapedRecipe(MalumItems.MOSSY_TWISTED_ROCK_BRICKS_STAIRS.get(), 4).key('#', MalumItems.MOSSY_TWISTED_ROCK_BRICKS.get()).patternLine("#  ").patternLine("## ").patternLine("###").addCriterion("has_twisted_rock", hasItem(MalumItems.TWISTED_ROCK.get())).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(MalumItems.MOSSY_TWISTED_ROCK_BRICKS_WALL.get(), 6).key('#', MalumItems.MOSSY_TWISTED_ROCK_BRICKS.get()).patternLine("###").patternLine("###").addCriterion("has_twisted_rock", hasItem(MalumItems.TWISTED_ROCK.get())).build(consumer);
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MalumItems.MOSSY_TWISTED_ROCK_BRICKS.get()), MalumItems.MOSSY_TWISTED_ROCK_BRICKS_SLAB.get(), 2).addCriterion("has_mossy_twisted_rock_bricks", hasItem(MalumItems.MOSSY_TWISTED_ROCK_BRICKS.get())).build(consumer, "mossy_twisted_rock_brick_slab_stonecutting");
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MalumItems.MOSSY_TWISTED_ROCK_BRICKS.get()), MalumItems.MOSSY_TWISTED_ROCK_BRICKS_STAIRS.get()).addCriterion("has_mossy_twisted_rock_bricks", hasItem(MalumItems.MOSSY_TWISTED_ROCK_BRICKS.get())).build(consumer, "mossy_twisted_rock_brick_stairs_stonecutting");
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MalumItems.MOSSY_TWISTED_ROCK_BRICKS.get()), MalumItems.MOSSY_TWISTED_ROCK_BRICKS_WALL.get()).addCriterion("has_mossy_twisted_rock_bricks", hasItem(MalumItems.MOSSY_TWISTED_ROCK_BRICKS.get())).build(consumer, "mossy_twisted_rock_brick_wall_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MalumItems.TWISTED_ROCK_TILES.get()), MalumItems.TWISTED_ROCK_TILES_SLAB.get(), 2).addCriterion("has_twisted_rock_tiles", hasItem(MalumItems.TWISTED_ROCK_TILES.get())).build(consumer, "twisted_rock_tiles_slab_stonecutting");
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MalumItems.TWISTED_ROCK_TILES.get()), MalumItems.TWISTED_ROCK_TILES_STAIRS.get()).addCriterion("has_twisted_rock_tiles", hasItem(MalumItems.TWISTED_ROCK_TILES.get())).build(consumer, "twisted_rock_tiles_stairs_stonecutting");
        ...
        shapelessRecipe(MalumItems.MOSSY_TWISTED_ROCK_TILES.get()).addIngredient(MalumItems.TWISTED_ROCK_TILES.get()).addIngredient(Blocks.VINE).addCriterion("has_twisted_rock", hasItem(MalumItems.TWISTED_ROCK.get())).build(consumer);
        shapedRecipe(MalumItems.MOSSY_TWISTED_ROCK_TILES_SLAB.get(), 6).key('#', MalumItems.MOSSY_TWISTED_ROCK_TILES.get()).patternLine("###").addCriterion("has_twisted_rock", hasItem(MalumItems.TWISTED_ROCK.get())).build(consumer);
        shapedRecipe(MalumItems.MOSSY_TWISTED_ROCK_TILES_STAIRS.get(), 4).key('#', MalumItems.MOSSY_TWISTED_ROCK_TILES.get()).patternLine("#  ").patternLine("## ").patternLine("###").addCriterion("has_twisted_rock", hasItem(MalumItems.TWISTED_ROCK.get())).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(MalumItems.MOSSY_TWISTED_ROCK_TILES_WALL.get(), 6).key('#', MalumItems.MOSSY_TWISTED_ROCK_TILES.get()).patternLine("###").patternLine("###").addCriterion("has_twisted_rock", hasItem(MalumItems.TWISTED_ROCK.get())).build(consumer);
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MalumItems.MOSSY_TWISTED_ROCK_BRICKS.get()), MalumItems.MOSSY_TWISTED_ROCK_TILES.get()).addCriterion("has_twisted_rock", hasItem(MalumItems.TWISTED_ROCK.get())).build(consumer, "mossy_twisted_rock_tiles_stonecutting");
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MalumItems.MOSSY_TWISTED_ROCK_TILES.get()), MalumItems.MOSSY_TWISTED_ROCK_TILES_SLAB.get(), 2).addCriterion("has_twisted_rock", hasItem(MalumItems.TWISTED_ROCK.get())).build(consumer, "mossy_twisted_rock_tiles_slab_stonecutting");
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MalumItems.MOSSY_TWISTED_ROCK_TILES.get()), MalumItems.MOSSY_TWISTED_ROCK_TILES_STAIRS.get()).addCriterion("has_twisted_rock", hasItem(MalumItems.TWISTED_ROCK.get())).build(consumer, "mossy_twisted_rock_tiles_stairs_stonecutting");
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MalumItems.MOSSY_TWISTED_ROCK_TILES.get()), MalumItems.MOSSY_TWISTED_ROCK_TILES_WALL.get()).addCriterion("has_twisted_rock", hasItem(MalumItems.TWISTED_ROCK.get())).build(consumer, "mossy_twisted_rock_tiles_wall_stonecutting");
