...
public class EssenceHolderBlockItem extends BlockItem implements ISpiritHolderBlockItem
{
    private final int maxSpirits;
    public EssenceHolderBlockItem(Block blockIn, Properties builder, int maxSpirits)
    {
