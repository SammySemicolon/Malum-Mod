...
public abstract class MalumRiteEffect {
    ...
    public Stream<BlockPos> getNearbyBlocks(TotemBaseBlockEntity totemBase, Class<?> clazz) {
        HashSet<Block> blockFilters = getBlockFilters(totemBase);
    ...
    public HashSet<Block> getBlockFilters(TotemBaseBlockEntity totemBase) {
    ...
    public boolean canAffectBlock(TotemBaseBlockEntity totemBase, HashSet<Block> filters, Class<?> clazz, BlockState state, BlockPos pos) {
