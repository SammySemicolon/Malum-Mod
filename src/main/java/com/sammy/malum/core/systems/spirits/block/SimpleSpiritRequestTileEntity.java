...
public class SimpleSpiritRequestTileEntity extends SimpleTileEntity implements ISpiritRequestTileEntity
{
    protected ArrayList<BlockPos> cachedHolders;
    public SimpleSpiritRequestTileEntity(TileEntityType type)
    {
        super(type);
    }
    @Override
