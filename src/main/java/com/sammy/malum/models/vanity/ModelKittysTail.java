...
public class ModelKittysTail<T extends LivingEntity> extends BipedModel<T>
{
	...
	public ModelKittysTail() {
		...
		tailtip.setTextureOffset(0, 20).addBox(-2.5F, -2.0F, -2.0F, 5.0F, 4.0F, 4.0F, 0.0F, false);
		...
		tailtip1.setTextureOffset(14, 8).addBox(0.0F, -5.0F, -2.5F, 0.0F, 5.0F, 5.0F, 0.0F, false);
		
		ModelRenderer tailtip2 = new ModelRenderer(this);
		tailtip2.setRotationPoint(0.0F, -0.5F, 0.0F);
		tailtip.addChild(tailtip2);
		setRotationAngle(tailtip2, 0.0F, 0.7854F, 0.0F);
		tailtip2.setTextureOffset(14, 8).addBox(0.0F, -5.0F, -2.5F, 0.0F, 5.0F, 5.0F, 0.0F, false);
	}
