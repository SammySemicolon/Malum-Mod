...
public class CurioTotemOfEternalLife extends Item implements ICurio, SpiritConsumer, SpiritDescription
{
    public CurioTotemOfEternalLife(Properties builder)
    {
        super(builder);
    }
    ...
    public ArrayList<ITextComponent> components()
    {
        ...
        components.add(makeGenericSpiritDependantTooltip("malum.tooltip.totem_of_eternal_life.effect", SpiritDataHelper.getName(spirit())));
        return components;
    }
}