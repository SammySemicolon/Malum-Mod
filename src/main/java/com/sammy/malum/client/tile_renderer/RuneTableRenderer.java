...
public class RuneTableRenderer extends TileEntityRenderer<RuneTableTileEntity>
{
    public RuneTableRenderer(Object rendererDispatcherIn)
    {
        super((TileEntityRendererDispatcher) rendererDispatcherIn);
    }

    @Override
    public void render(RuneTableTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn)
    {
        ...
        {
            matrixStackIn.push();
            Vector3f offset = new Vector3f(RuneTableTileEntity.itemOffset());
