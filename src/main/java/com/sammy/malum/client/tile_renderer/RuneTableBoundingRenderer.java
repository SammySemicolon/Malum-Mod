...
public class RuneTableBoundingRenderer extends TileEntityRenderer<RuneTableBoundingBlockTileEntity>
{
    public RuneTableBoundingRenderer(Object rendererDispatcherIn)
    {
        super((TileEntityRendererDispatcher) rendererDispatcherIn);
    }

    @Override
    public void render(RuneTableBoundingBlockTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn)
    {
        ...
        {
            matrixStackIn.push();
            Vector3f offset = new Vector3f(RuneTableBoundingBlockTileEntity.itemOffset(tileEntityIn));
