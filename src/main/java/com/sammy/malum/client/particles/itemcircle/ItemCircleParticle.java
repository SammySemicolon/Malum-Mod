...
public class ItemCircleParticle extends MalumParticle
{
    ...
    {
        super(world, data, xSpeed, ySpeed, zSpeed, x, y, z, spriteSet, new ParticlePhase(0, 15, 1, 0));
    ...
    public static class Factory implements IParticleFactory<MalumParticleData>
    {
        ...
        {
            return new ItemCircleParticle(world,data, xSpeed, ySpeed, zSpeed, x, y, z, spriteSet);
        }
    }
}