...
import static com.sammy.malum.client.screen.old_book.categories.DiscoveryCategory.*;
...
public class SpiritTinkeringCategory extends BookCategory
{
    ...
    public SpiritTinkeringCategory()
    {
        ...
        spirit_resonators = new BookEntry(HALLOWED_SPIRIT_RESONATOR.get(), "spirit_resonators")
                ...
                .addLink(()->runewood_trees).addLink(()->soul_stained_steel).addLink(()->hallowed_gold);
        ...
        tyrving = new BookEntry(TYRVING.get(), "tyrving")
                ...
                .addLink(()->spirit_infusion).addLink(()->soul_stained_steel).addLink(()->soulstone);
        ...
        addEntries(soul_stained_steel, hallowed_gold, curios, spirit_resonators, arcane_spoil_ring, arcane_reach_ring, ring_of_prowess, tyrving, radiant_soulstone, stronghold_armor);
    }
}
