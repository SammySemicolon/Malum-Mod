...
public class RuneworkingPage<T extends EntryScreen<T, ?>> extends BookPage<T> {
    ...
    public static <T extends EntryScreen<T, ?>> RuneworkingPage<T> fromOutput(Item outputItem) {
