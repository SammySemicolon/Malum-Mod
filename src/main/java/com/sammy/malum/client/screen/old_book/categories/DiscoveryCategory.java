...
import com.sammy.malum.client.screen.old_book.pages.*;
...
public class DiscoveryCategory extends BookCategory
{
    ...
    public DiscoveryCategory()
    {
        ...
        runewood_trees = new BookEntry(RUNEWOOD_SAPLING.get(), "runewood")
                ...
                .addPage(new ItemListPage(RUNEWOOD_PLANKS.get(), VERTICAL_RUNEWOOD_PLANKS.get(), RUNEWOOD_PANEL.get(), RUNEWOOD_TILES.get())
                        .addList(RUNEWOOD_PLANKS_SLAB.get(), VERTICAL_RUNEWOOD_PLANKS_SLAB.get(), RUNEWOOD_PANEL_SLAB.get(), RUNEWOOD_TILES_SLAB.get())
                        .addList(RUNEWOOD_PLANKS_STAIRS.get(), VERTICAL_RUNEWOOD_PLANKS_STAIRS.get(), RUNEWOOD_PANEL_STAIRS.get(), RUNEWOOD_TILES_STAIRS.get())
                        .addList(CUT_RUNEWOOD_PLANKS.get(), RUNEWOOD_BEAM.get()))
