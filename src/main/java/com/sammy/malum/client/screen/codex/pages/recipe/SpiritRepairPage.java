...
public class SpiritRepairPage<T extends AbstractProgressionCodexScreen<T>> extends BookPage<T> {
    ...
    public static <T extends AbstractProgressionCodexScreen<T>> SpiritRepairPage<T> fromInput(Item inputItem) {
