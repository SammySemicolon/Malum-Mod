...
public class MinorEntryObject extends EntryObject {
    ...
    public void render(Minecraft minecraft, GuiGraphics guiGraphics, float xOffset, float yOffset, int mouseX, int mouseY, float partialTicks) {
        ...
        renderTexture(FRAME_TEXTURE, guiGraphics.pose(), posX, posY, 67, getFrameTextureV(), width, height, 512, 512);
        renderTexture(FRAME_TEXTURE, guiGraphics.pose(), posX, posY, 166, getBackgroundTextureV(), width, height, 512, 512);
