...
public class ModelSoulStainedStrongholdArmor extends ModelArmor
{
	...
	public ModelSoulStainedStrongholdArmor(EquipmentSlotType slot) {
		...
		chestplate_slope.setTextureOffset(19, 22).addBox(5.5F, -2.0706F, -7.7274F, 5.0F, 2.0F, 1.0F, 0.0F, false);
		...
		arm_l.setTextureOffset(44, 14).addBox(0.0F, -4.0F, -3.0F, 4.0F, 6.0F, 6.0F, 0.025F, false);
		arm_l.setTextureOffset(42, 26).addBox(-1.5F, 5.0F, -3.0F, 5.0F, 6.0F, 6.0F, 0.025F, false);
		arm_l.setTextureOffset(48, 7).addBox(0.5F, 3.0F, -2.5F, 3.0F, 2.0F, 5.0F, 0.025F, false);
		
		leg_r = new ModelRenderer(this);
		leg_r.setRotationPoint(-2.0F, 12.0F, 0.0F);
		leg_r.setTextureOffset(12, 47).addBox(-2.5F, -0.5F, -2.5F, 5.0F, 7.0F, 5.0F, 0.025F, true);
		...
		boot_r_r1.setRotationPoint(2.0F, 12.0F, 0.0F);
		boot_r.addChild(boot_r_r1);
		setRotationAngle(boot_r_r1, 0.0F, -0.0436F, 0.0F);
		boot_r_r1.setTextureOffset(29, 39).addBox(-5.0F, -6.0F, -3.0F, 6.0F, 7.0F, 6.0F, 0.0F, true);
		...
		boot_wing_r.setTextureOffset(25, 53).addBox(-4.0F, 4.3639F, -8.364F, 1.0F, 4.0F, 7.0F, 0.025F, true);
		...
		thigh_guard_r.setTextureOffset(0, 53).addBox(-3.0F, -1.0003F, -3.0F, 3.0F, 5.0F, 6.0F, 0.05F, true);
		...
		boot_l_r1.setRotationPoint(-2.0F, 12.0F, 0.0F);
		boot_l.addChild(boot_l_r1);
		setRotationAngle(boot_l_r1, 0.0F, 0.0436F, 0.0F);
		boot_l_r1.setTextureOffset(29, 39).addBox(-1.0F, -6.0F, -3.0F, 6.0F, 7.0F, 6.0F, 0.0F, false);
